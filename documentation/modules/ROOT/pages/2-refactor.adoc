...
Let's go back to the link:https://tackle-tackle-%USERID%.apps.%SUBDOMAIN%/applications/analysis-tab[Tackle Analysis web console^]. Then, create a new inventory to analyze the modernized application (*customers*). 
