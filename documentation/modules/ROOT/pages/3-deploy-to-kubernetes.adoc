...
* アクセス
このアプリケーションが「customers-qa-%USERID%」プロジェクトで実行されている場合は、 link:https://console-openshift-console.%SUBDOMAIN%/topology/ns/customers-qa-%USERID%?view=graph[Topology view^] にアクセスしてください。
